...
public class ProductCode {
    ...
    private ProductCode(ResultSet set) {
         ...
         */
        try {
            setCode(set.getString("code"));
            setDiscountCode(set.getString("discountCode").charAt(0));
    ...
    public static PreparedStatement getInsertQuery(Connection connection) throws SQLException {
         ...
         */
        String inQuery = "INSERT INTO PRODUCT_CODE(code,discountCode,description) VALUES(?,?,?)";
        return connection.prepareStatement(inQuery);
    }
    ...
    public static PreparedStatement getUpdateQuery(Connection connection) throws SQLException {
         ...
         */
        return connection.prepareCall("UPDATE PRODUCT_CODE set CODE=?, DISCOUNTCODE=?, DESCRIPTION=? where CODE=?");
    }
